	...
	public class StudentTests {
		...
		public class ElectionTests {
			...
			public void testConstructor1() {
				...
				assertAll(
						() -> assertTrue(election.getWinner().equals("Pepe Perez"), "Didn't get Correct winner." + election.getWinner()),
			...
			public void testConstructor2() {
				...
				//Summary Report
				election.summaryWriter();
				//Not working, it prints all the candidates as eliminated
